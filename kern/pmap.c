...
void mem_init(void) {
  ...
  // somewhere betw KERNBASE and KERNBASE+4MB right now, which is
...
struct PageInfo *page_alloc(int alloc_flags) {
  ...
  // Set pp_link field to NULL to avoid double-free bugs.
  result->pp_link = NULL;
